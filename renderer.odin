...
init_terminal :: proc(width, height, char_width, char_height: int, fg, bg: Color, atlas_filepath: string) -> (term: Terminal) {
        ...
        for y in 0..<term.height {
            for x in 0..<term.width {
                ...
                if new_glyph.char != old_glyph.char || new_glyph.fg != old_glyph.fg {
                    ...
                    rl.BeginScissorMode(i32(x*term.char_width), i32(y*term.char_height), i32(term.char_width), i32(term.char_height))
